  ...
  const nextStep = async () => {
    ...
    if (step === 3) {
      ...
      if (subStep === 'uploading') {
        ...
        payload.append('kycDocument', uploadedFile);
        payload.append('kycType', ['Government ID', 'Business Permit', 'Farm Certification'][selectedDoc || 0]);
              ...
              {subStep === 'otp' ? (
                <div className="flex flex-col items-center space-y-10 text-center">
                  ...
                  <button
                    ...
                    className="text-xs font-bold text-primary underline disabled:text-slate-400 cursor-pointer disabled:cursor-not-allowed"
                  >
